 ...
 */
public class DeliveryCostFragment extends BaseFragment implements
    ...
    @BindView(R.id.fragdelivery_recycleView)LoadMoreRecyclerView recyclerView;
    ...
    protected View initContentView(LayoutInflater inflater) {
        View view = inflater.inflate(R.layout.fragment_deliverycost,null);
        ButterKnife.bind(this,view);
        setNetListener(this);
        setRefreshEnable(true);
        setRefreshListener(this);
        getAllDetail(TYPE_REFRESH,TRADE_TYPE1,min_id+"");
        return view;
    }
    ...
    public void onLoadMore() {
        getAllDetail(TYPE_LOADMORE,TRADE_TYPE1,min_id+"");
    }
}