 ...
 */
public class OtherDetailFragment extends BaseFragment implements
    ...
    @BindView(R.id.fragotherdetail_recycleView)LoadMoreRecyclerView recyclerView;
    ...
    protected View initContentView(LayoutInflater inflater) {
        View view = inflater.inflate(R.layout.fragment_otherdetail,null);
        ButterKnife.bind(this,view);
        setNetListener(this);
        setRefreshEnable(true);
        setRefreshListener(this);
        getAllDetail(TYPE_REFRESH,TRADE_TYPE3,min_id+"");
        return view;
    }
    ...
    public void onRefresh() {
        getAllDetail(TYPE_REFRESH,TRADE_TYPE3,"-1");
    }
    ...
    public void onLoadMore() {
        getAllDetail(TYPE_LOADMORE,TRADE_TYPE3,min_id+"");
    }
}
