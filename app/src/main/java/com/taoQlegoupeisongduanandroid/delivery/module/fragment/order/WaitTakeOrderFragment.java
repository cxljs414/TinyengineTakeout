 ...
 */
public class WaitTakeOrderFragment extends BaseFragment implements
        NetChangeListener,SwipeRefreshLayout.OnRefreshListener,LoadMoreRecyclerView.LoadMoreListener
{
    ...
    private CommRecyclerAdapter<OrderBean.ListEntity> adapter;private List<OrderBean.ListEntity> mDatas = new ArrayList<>();
    ...
    protected View initContentView(LayoutInflater inflater) {
        ...
        getOrderList(TYPE_REFRESH,TRADE_TYPE7,min_id+"");
        return view;
    }
    ...
    private void initView() {
        ...
        adapter = new CommRecyclerAdapter<OrderBean.ListEntity>(
            ...
            public void convert(ViewHolder holder, final OrderBean.ListEntity entity, final int position) {
                ...
                holder.setText(R.id.itemwaittakeorder_custommobiletile,"店");
                holder.setText(R.id.itemwaittakeorder_custommobile,entity.getStore().getTelephone());
                ...
                holder.setOnClickListener(R.id.itemwaittakeorder_custommobilecontain, new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        CommonUtils.telphoneCall(mContext,entity.getStore().getTelephone());
                    }
                });
    ...
    public void onLoadMore() {
        getOrderList(TYPE_LOADMORE,TRADE_TYPE7,min_id+"");
    }
