package com.p_v.flexiblecalendar.util;
...
public class LunhCalendarUtil {
     ...
     * @return
     */
    public LunhCalendarUtil(Calendar cal) {
    ...
    public static String getCurrentDay(Calendar calendar) {
        return getDay(calendar) + " 农历" + new LunhCalendarUtil(calendar).getDay() + " " + getWeek(calendar);
    }
